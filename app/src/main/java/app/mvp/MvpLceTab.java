 ...
 */
public abstract class MvpLceTab<M, V extends MvpLceView<M>, P extends MvpLcePresenter<V, M>>
        extends MvpTab<V, P>
...
//                    finish();
    ...
    public abstract void onAddContentView(LayoutInflater inflater, @Nullable ViewGroup container);
...
//        Intent intent = new Intent(getContext(), LoginActivity.class);
//        intent.setAction(LoginActivity.ACTION_REGISTER);
//        intent.putExtra(LoginActivity.EXTRA_PROMPT, prompt);
//        startActivity(intent);
    }
