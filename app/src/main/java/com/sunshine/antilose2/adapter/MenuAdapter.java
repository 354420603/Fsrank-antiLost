 ...
 */
package com.sunshine.antilose2.adapter;
...
public class MenuAdapter extends SwipeMenuAdapter<MenuAdapter.DefaultViewHolder> {
    ...
    public MenuAdapter(List<BluetoothDeviceBean> titles) {
        this.titles = titles;
    }

    public void setData(List<BluetoothDeviceBean> beanList) {
        titles = beanList;
    ...
    static class DefaultViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public DefaultViewHolder(View itemView) {
            ...
            checkBoxState = (CheckBox) itemView.findViewById(R.id.cb_state);
        }
        ...
        public void setData(BluetoothDeviceBean device) {
            this.tvName.setText(device.getName());
            this.tvAddress.setText(device.getAddress());
            this.checkBoxState.setChecked(device.getState());
        }
